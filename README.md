...
## Overview:
At a time when there is file or pictures is uploaded in the images folder which is selected of the bucket then we will receive an alert on the mailbox. The mail receive only on seccess due do discipline is selected for success.
